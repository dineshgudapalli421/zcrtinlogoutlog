		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create Inlog and Out log",
									"targetURL": "#comlhsapui5zcrtinlogoutlog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlhsapui5zcrtinlogoutlog-display": {
								"semanticObject": "comlhsapui5zcrtinlogoutlog",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lh.sapui5.zcrtinlogoutlog",
									"url": sap.ui.require.toUrl("com/lh/sapui5/zcrtinlogoutlog")
								}
							}
						}
					}
