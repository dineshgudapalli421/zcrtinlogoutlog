		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monitor Field Completion Work",
									"targetURL": "#comsaplhcszlhmonitorfieldwork-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhcszlhmonitorfieldwork-display": {
								"semanticObject": "comsaplhcszlhmonitorfieldwork",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.cs.zlhmonitorfieldwork",
									"url": sap.ui.require.toUrl("com/sap/lh/cs/zlhmonitorfieldwork")
								}
							}
						}
					}
